...
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.35]{\string"../Documents/113 Architecture/img/cpu\string".png}
\end{figure}
...
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.2]{\string"../Documents/113 Architecture/img/cpu-hardware\string".png}
\end{figure}
...
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.275]{\string"../Documents/113 Architecture/img/microsteps\string".png}
\end{figure}
...
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.325]{\string"../Documents/113 Architecture/img/rom-implementation\string".png}
\end{figure}
...
\end{enumerate}
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.375]{\string"../Documents/113 Architecture/img/microsequencer-implementation\string".png}
\end{figure}
