...
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.35]{\string"img/cpu\string".png}
\end{figure}
...
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.2]{\string"img/cpu-hardware\string".png}
\end{figure}
...
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.275]{\string"img/microsteps\string".png}
\end{figure}
...
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.325]{\string"img/rom-implementation\string".png}
\end{figure}
...
\end{enumerate}
\begin{figure}[H]
\noindent \centering{}\includegraphics[scale=0.375]{\string"img/microsequencer-implementation\string".png}
\end{figure}
